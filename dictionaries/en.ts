              ...
              pages:
                  {
                    ieseg: {
                      ...
                      subtitle:
                          "A unique partnership for innovative and effective solutions",
                      presentation: {
                        title: "Presentation of IÉSEG Conseil Paris",
                        par:
                            "IÉSEG CONSEIL Paris, Junior-Enterprise of the IÉSEG School of Management, is a Junior-Enterprise whose members are students specializing in Management, Marketing, Finance, Auditing and Information Systems. Created in 2007, IÉSEG CONSEIL Paris offers the expertise and dynamism of its junior consultants to support you in your consulting projects in strategy, organization, marketing, finance and information systems."
                      },
                      complementary: {
                        title: "Complementary Expertise",
                        before:
                            "By combining the technical expertise of Telecom Etude and the commercial expertise of IÉSEG Conseil Paris, we offer a complete solution that covers all aspects of your projects, from engineering to market strategy",
                        strong:
                            " Our approach enables us to support you from A to Z, integrating an assessment of technical feasibility with an in-depth analysis of market demand. ",
                        after:
                            "We believe that every project has unique potential. Choose a two-pronged approach combining technical expertise and commercial perspective to explore your product's potential.",
                        alt:
                            "Complementarity Graph Telecom Etude IÉSEG Conseil Paris."
                      },
                      innovation: {
                        title: "Innovative Solutions",
                        before:
                            "We use the latest technologies and data science methods to analyze the market and improve the online visibility of your products, enabling you to stay at the forefront of innovation.",
                        strong:
                      ...
                      gain: {
                        ...
                        before:
                            "Working hand in hand, we offer an integrated process that saves you time and efficiency. You benefit from our combined skills, without having to coordinate multiple service providers.",
                        strong:
                            " Our collaboration translates into detailed pre-studies, rigorous progress monitoring and clear deliverables, enabling your projects to be implemented quickly and efficiently."
                      },
                      contact: "Contact us!"
                    },
                    offer:
                          ...
                          timeline:
                              {
                                ...
                                text:
                                    "We have a structured and rigorous approach to ensure quality, expertise, and responsiveness throughout the mission. Here are the main steps in conducting a study at JE:",
                                steps:
                                    [
                                      {
                                        title: "Client Contact",
                                        text:
                                            "The first contact between you and our Junior Enterprise. You can reach us through the form below or at contact@telecom-etude.fr. We will respond as soon as possible to schedule an initial meeting."
                                      },
                                      {
                                      ...
                                      },
                                      {
                                        ...
                                        text:
                                            "Following this meeting, we will draft a personalized commercial offer outlining the key points of your project and how we can address them. This commercial offer will also include an estimate of the budget and duration of the mission."
                                      },
                                      {
                                        title: "Search for Contributors",
                                        text:
                                            "We then publish a call for applications to the students of Télécom Paris to gather the best profiles to execute your project. After a detailed analysis of the candidates' skills, experience, and motivation, we will meet them for an interview to ensure their qualifications meet the mission's needs."
                                      },
                                      {
                                        title: "Tripartite Meeting",
                                        text:
                                            "After the selection, you will meet the contributor in a second meeting to clarify all the details of your project in light of their expertise. It is especially through this exchange that we can build a precise and comprehensive specifications document."
                                      },
                                      {
                                        title: "Signing the Study Agreement",
                                        text:
                                            "Finally, we formalize all the details of the mission in a study agreement that includes the complete specifications document, the methodology applied by the contributor, the schedule for the various stages of the mission, the expected deliverables, as well as the budget for the mission. Once this document is signed, the mission can officially begin!"
                                      },
                                      {
                                        title:
                                            "Mission Follow-up with the Contributor",
                                        text:
                                            "We organize regular follow-up meetings with you to ensure that the mission stays on track and meets the deadlines! Throughout the mission, our project managers are your primary contacts and keep you informed of the project's progress."
                                      },
                                      {
                                        title:
                                            "Payment and Satisfaction Feedback",
                                        text:
                                            "Once the mission is completed, we meet one last time to present the final deliverable, which you confirm is in accordance with the specifications by signing. You will also receive a satisfaction questionnaire that allows you to evaluate your experience with our organization."
                                      }
                                    ]
                              },
                          plaquette: {
                    ...
                    home: {
                      ...
                      subtitle:
                          "The Junior Enterprise for digital, new technologies and data",
                      ...
                      domains: {
                        ...
                        cyber:
                            "Cybersecurity, Networks, Cryptography & Blockchain",
                    ...
                    partners: {
                      ...
                      text:
                          "Telecom Etude has partner companies. These partnerships with companies allow us to benefit from practical training, to lend our premises for their events, and to establish solid professional relationships. As students, this is a unique opportunity to acquire skills while discovering the business world. It strengthens our future opportunities and develops our network",
                      bain: {
                        type: "Consulting firm",
                        text:
                            "Bain & Company is the international consulting firm that helps ambitious managers transform their companies into pioneers of tomorrow's world. This prestigious partnership enables us to put Telecom Paris students in touch with Bain & Company consultants and recruiters through special events."
                      },
                      kpmg: {
                        type: "Audit and consulting",
                        text:
                            "Our partnership with KPMG is designed to benefit both parties. In return, KPMG, in collaboration with Telecom Etude, organises events for students at Telecom Etude's premises during the year to introduce them to the consulting professions, as well as a visit to KPMG's premises at the end of the year accompanied by a discussion in small groups."
                      },
                      bearingPoint: {
                        type: "Consulting firm",
                        text:
                    ...
                    faq: {
                      ...
                      text: {
                        before:
                            "Here are answers to questions you might have. Don't hesitate to contact us at ",
                        between: "or by filling the ",
                        form: "contact form",
                        after:
                            "if you have any other questions or in order to have more information."
                      },
                      list: [
                        {
                    ...
                    about:
                        {
                          description:
                              "The Junior-Enterprise of digital and data",
                          ...
                          ourshool: {
                            chooseTP:
                                "Choosing Télécom Paris means choosing the Junior-Enterprise of",
                            rankings: [
                    ...
                    contact: {
                      ...
                      optional: "optional",
                      before:
                          "You have a project in mind? You need more information about our services? Don't hesitate to contact us using the form below or by sending us an email at ",
                      after: ". We will get back to you as soon as possible.",
                      terms:
                          "By submitting this form, you agree that your data will be used to contact you in connection with your request and the commercial relationship that may result from it.",
                      form: {
                        name: {
                          label: "Name",
                      ...
                      error: {
                        title: "Unexpected error...",
                        message:
                            "Please contact us instead by sending a mail to"
                      }
                    },
                    legal: {
                      title: "Legal Notice",
                      legal: {
                        ...
                        director: {
                          ...
                          description:
                              "Manon Strasser, Chief Executive Officer of Telecom Etude"
                        },
                        host: {
                          title: "Site Host",
                          description:
                              "Rezel, residing at 19, Place Marguerite Perey, 91120, PALAISEAU",
                          contact: "Contact: ",
                          website: "Website: "
                        }
                      },
