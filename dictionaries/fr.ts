  ...
  navigation: {
    ...
    errors: {
      ...
      forbidden: {
        ...
        description:
            'Vous ne disposez pas des autorisations nécessaires pour accéder à cette page. Veuillez contacter l\'administrateur',
      ...
      notfound: {
        ...
        description:
            'La page que vous recherchez n\'existe pas. Veuillez vérifier l\'URL ou retourner à la page d\'accueil',
        button: 'Retourner à la page d\'accueil',
        contact: null
      },
      unknown: {
    ...
    button: {open: 'Ouvrir le menu', close: 'Fermer le menu'}
  },
  pages: {
    ieseg: {
      title: 'Telecom Etude et IÉSEG Conseil Paris',
      subtitle:
          'Un partenariat unique pour des solutions innovantes et efficaces',
      presentation: {
        title: 'Présentation IÉSEG Conseil Paris',
        par:
            ' IÉSEG CONSEIL Paris, Junior-Entreprise de l\'IÉSEG School of Management, est une Junior-Entreprise dont les membres sont des étudiants spécialisés en Management, Marketing, Finance, Audit et Systèmes d\'information. Créée en 2007, IÉSEG CONSEIL Paris met à votre disposition l\'expertise et le dynamisme de ses consultants juniors pour vous accompagner dans vos projets de conseil en stratégie, organisation, marketing, finance et systèmes d\'information.'
      },
      complementary: {
        title: 'Expertise Complémentaire',
        before:
            'En combinant l\'expertise technique de Telecom Etude et l\'expertise commerciale de IÉSEG Conseil Paris, nous offrons une solution complète qui couvre tous les aspects de vos projets, de l\'ingénierie à la stratégie de marché.',
        strong:
            ' Notre approche permet de vous accompagner de A à Z, en intégrant une évaluation de la faisabilité technique et une analyse approfondie de la demande du marché. ',
        after:
            'Nous croyons que chaque projet a un potentiel unique. Faites le choix d\'une approche à double facette alliant expertise technique et perspective commerciale pour explorer le potentiel de votre produit.',
        alt: 'Graphique Complémentarité Telecom Etude IÉSEG Conseil Paris'
      },
      innovation: {
        title: 'Solutions Innovantes',
        before:
            'Nous utilisons les dernières technologies et méthodes de data science pour analyser le marché et améliorer la visibilité en ligne de vos produits, vous permettant ainsi de rester à la pointe de l\'innovation.',
        strong:
            ' Nos services incluent l\'implantation de nouvelles technologies, le lancement de nouveaux produits et l\'optimisation de vos performances grâce à des régressions multi-linéaires et des outils de visualisation de données. '
      },
      personalisedApproach: {
        title: 'Approche personnalisée',
        before:
            'Chaque projet est unique. Nous adaptons nos services à vos besoins spécifiques, que ce soit pour évaluer la faisabilité d\'un nouveau produit, optimiser votre service client ou améliorer votre stratégie marketing.',
        strong:
            'Notre approche personnalisée garantit des résultats concrets en s\'appuyant sur des visites mystères, des exit interviews et des benchmarks sectoriels adaptés à vos enjeux particuliers.'
      },
      gain: {
        title: 'Gain de Temps et d\'Efficacité',
        before:
            'En travaillant main dans la main, nous offrons un processus intégré qui vous permet de gagner du temps et de l\'efficacité. Vous bénéficiez de nos compétences combinées sans avoir à coordonner plusieurs prestataires.',
        strong:
            ' Notre collaboration se traduit par une pré-étude détaillée, un suivi rigoureux de l\'avancement et des livrables clairs, permettant une mise en œuvre rapide et efficace de vos projets.'
      },
      contact: 'Contactez-nous !'
    },
    offer: {
      ...
      timeline: {
        ...
        text:
            'Nous avons une approche cadrée et rigoureuse afin de suivre avec qualité, expertise et réactivité la mission. Voici les étapes principales du déroulement d\'une étude à la JE:',
        steps: [
          {
            title: 'Contact du client',
            text:
                'Première mise en relation entre vous et notre Junior Entreprise. Vous pouvez nous contacter via le formulaire ci-dessous ou sur contact@telecom-etude.fr. Nous vous répondrons dans les plus brefs délais afin de planifier une première réunion.'
          },
          {
            title: 'Réunion avec le client',
            text:
                'Deux chefs de projet vous reçoivent dans nos locaux à Télécom Paris ou lors d\'une visioconférence. Le but de cette réunion pour nous est de comprendre en détails les besoins de votre projet afin de vous proposer par la suite une offre adaptée à vos attentes. Nous établissons notamment ensemble les lignes directrices du cahier des charges.'
          },
          {
            title: 'Offre commerciale',
            text:
                'À la suite de cette réunion, nous rédigeons une offre commerciale personnalisée qui présente les points clés de votre projet et la manière dont nous pouvons les adresser. Vous recevez également dans cette offre commerciale une estimation du budget et de la durée de la mission.'
          },
          {
          ...
          },
          {
            ...
            text:
                'A l\'issue de la sélection, vous rencontrez l\'intervenant lors d\'une seconde réunion afin de préciser à la lumière de son expertise tous les détails de votre projet. C\'est en particulier grâce à cet échange que nous pouvons construire un cahier des charges précis et exhaustif.'
          },
          {
            title: 'Signature de la Convention d\'étude',
            text:
                'Nous formalisons enfin tous les détails de la mission dans une convention d\'étude qui contient notamment le cahier des charges complet, la méthodologie appliquée par l\'intervenant, le planning de réalisation des différentes étapes de la mission, les différents livrables attendus ainsi que le budget de la mission. Une fois ce document signé, la mission peut réellement commencer !'
          },
          {
            title: 'Suivi mission avec l\'intervenant',
            text:
                'Nous organisons, avec vous, des points de suivi réguliers afin de s\'assurer que la mission suive la trajectoire prévue et respecte les délais fixés ! Durant toute la mission, nos chefs de projets sont vos interlocuteurs privilégiés et vous tiennent informés de l\'avancement du projet.'
          },
          {
            title: 'Paiement et retours de satisfaction',
            text:
                'Une fois la mission terminée, nous nous réunissons une dernière fois pour vous présenter le livrable final, que vous confirmez être conforme au cahier des charges via signature. Vous recevrez enfin un questionnaire de satisfaction qui vous permettra d’évaluer votre expérience avec notre structure.'
          }
        ]
      },
      plaquette: {
    ...
    blog: {
      ...
      date: {posted_by: 'Posté par', on: 'le'},
      labelSelector: {
        title: 'Filtrer par étiquette',
        selectorMessage: 'Sélectionnez-en au plus 3',
        empty: 'Aucun label trouvé'
      },
      none:
          'Aucun blog n\'a encore été publié, merci de revenir ultérieurement.'
    },
    home: {
      ...
      subtitle:
          'La Junior Entreprise du numérique, des nouvelles technologies et de la data',
      ...
      domains: {
        ...
        description:
            'Notre expertise et nos compétences s\'étendent sur une vaste étendue du numérique, dont voici quelques exemples:',
    ...
    team: {
      title: 'Notre équipe',
      alt: {before: 'Photo de', after: 'de Telecom Etude'},
      poles: {
        board: 'Le bureau',
    ...
    faq: {
      ...
      text: {
        ...
        after:
            'si vous avez d\'autres questions ou pour avoir plus d\'informations.'
      },
      list: [
        {
    ...
    contact: {
      ...
      optional: 'facultatif',
      before:
          'Vous avez un projet en tête\u00A0? Vous avez besoin de plus d\'informations sur notre offre\u00A0? N\'hésitez pas à nous contacter en utilisant le formulaire ci-dessous ou en nous envoyant un email à ',
      after: '. Nous reviendrons vers vous dès que possible.',
      terms:
          'En soumettant ce formulaire, vous acceptez que vos données soient utilisées pour vous recontacter dans le cadre de votre demande et de la relation commerciale qui peut en découler. ',
      form: {
        name: {
          label: 'Nom',
        ...
        societe: {label: 'Société', placeholder: 'Votre nom de société'},
        subject: {label: 'Objet', placeholder: 'Un titre pour votre message'},
        message: {
          label: 'Message',
    ...
    legal: {
      ...
      legal: {
        ...
        owner: {
          ...
          description:
              'Telecom Etude, demeurant à 19, Place Marguerite Perey, 91120, PALAISEAU',
        ...
        host: {
          ...
          description:
              'Rezel, demeurant à 19, Place Marguerite Perey, 91120, PALAISEAU',
          contact: 'Contact: ',
