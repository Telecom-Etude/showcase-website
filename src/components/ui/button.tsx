...
const buttonVariantsStyles = {
    default: "call2action text-primary-foreground hover:bg-primary/90 px-4",
    destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90 px-4",
    ...
    link: "text-primary underline-offset-4 hover:underline px-4",
    linkFooter: "text-primary underline-offset-4 hover:underline",
