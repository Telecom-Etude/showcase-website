...
export const ButtonLink = React.forwardRef<HTMLButtonElement, ButtonProps>(({ className, variant, size, asChild = false, ...props }, ref) => {
...
export const VariantLink = ({ target, className, btnCn, variant, href, children }: VariantLinkProps) => (
    <ButtonLink variant={variant} className={btnCn}>
