...
export function DataTable<TData, TValue>({ columns, data, filters, search_column }: DataTableProps<TData, TValue>) {
    ...
    return (
        <div className="space-y-4">
            <DataTableToolbar table={table} filters={filters} search_column={search_column} />
