    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <section className={section}>
                ...
                <Image
                    className="xl:w-1/3 sm:w-2/3 w-full bg-[#151f2a]"
                    placeholder="blur"
                    src={Logo}
                    alt="Graphique Telecom Etude IÉSEG Conseil Paris"
                />
            </section>
            <div>
                <section className={section}>
            ...
            <div>
                <section className={cn(section, 'space-y-0')}>
                    <div className="w-full sm:w-2/3">
                        ...
                        <ContactForm
                            emails={[process.env.FORM_DEST_EMAIL, process.env.IESEG_EMAIL]}
                            locale={locale}
                        />
                    </div>
                </section>
